...
public:
    /*
Note:- Start form the borders of height

We mark those height Visited from which we can easily go to the pacific.
Condition (curr_element>prev_element)
image

Now we can mark those height Visited from which we can go to the atlantic.
Condition (curr_element>prev_element)
image

Now, Finally We can store those height Which is visited from pacific and atlantic as well.
